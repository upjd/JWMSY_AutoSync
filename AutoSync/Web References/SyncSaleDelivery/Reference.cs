...
namespace AutoSync.SyncSaleDelivery {
    ...
    public partial class SyncSaleIssueBill : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void SyncOrderAsync(string cOrderNumber, string cEasNewOrder, string cGuid, int iCount, string cMemo) {
            this.SyncOrderAsync(cOrderNumber, cEasNewOrder, cGuid, iCount, cMemo, null);
        }
        
        /// <remarks/>
        public void SyncOrderAsync(string cOrderNumber, string cEasNewOrder, string cGuid, int iCount, string cMemo, object userState) {
            ...
            this.InvokeAsync("SyncOrder", new object[] {
                        ...
                        cGuid,
                        iCount,
                        cMemo}, this.SyncOrderOperationCompleted, userState);
        }
